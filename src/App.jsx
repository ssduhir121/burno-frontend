...
import { useState, useEffect, useRef } from 'react';
import { Popup, Widget } from '@typeform/embed-react';
...
export default function App() {
  ...
  // Custom styling for Typeform
  const typeformStyle = {
    fontFamily: "'Inter', sans-serif",
    fontSize: '16px',
  };

  // Custom Typeform settings with your company branding
  const typeformOptions = {
    ...
    buttonText: "Submit",
    autoClose: 3000,
    customIcon: "https://yourcompany.com/logo.png", // Add your company logo URL
    onSubmit: () => {
          ...
          <div className="relative w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-2xl bg-black border border-gray-700">
            <div className="flex items-center justify-between p-4 border-b border-gray-700 bg-black">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {/* <p className="text-gray-400 text-sm">Step 1: Contact Information</p> */}
                </div>
              </div>
              <button 
            ...
            <div className="h-[70vh]">
              <Widget 
                ...
                hidden={{
                  company: "SK Company", // Pass company name to Typeform
