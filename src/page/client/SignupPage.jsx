...
//   const [formError, setFormError] = useState(''); // ✅ Added this for form-level errors
...
//           }
//         } catch (backendError) {
//           console.warn('⚠️ Could not save to backend, but data saved to localStorage:', backendError.message);
//         }
//       }
...
//       } else {
//         // ✅ Using setFormError instead of undefined setError
//         setFormError(result?.message || 'Failed to send magic link. Please try again.');
//       }
//     } catch (error) {
//       console.error('Error during signup:', error);
//       setFormError('Failed to process signup. Please try again.');
//     } finally {
//       setIsLoading(false);
//     }
//   };
...
//       const result = await login(formData.email, 'client');
//       if (!result?.success) {
//         setFormError(result?.message || 'Failed to resend magic link');
//       }
//     } catch (error) {
//       console.error('Error resending magic link:', error);
//       setFormError('Failed to resend magic link');
//     } finally {
//       setIsLoading(false);
//     }
//   };
        ...
        <main className="flex-grow flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <div className="mt-6 space-y-3">
              ...
              <Link 
                to="/client/login"
                className="block w-full text-center text-gray-900 hover:text-black"
              >
                Go to login page
              </Link>
            </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center p-4 py-8">
        <div className="max-w-7xl w-full">
          ...
          {/* Benefits Card Section - Below the form */}
