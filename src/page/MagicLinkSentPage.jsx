...
const MagicLinkSentPage = () => {
  ...
  useEffect(() => {
    ...
    console.log('🔍 MagicLinkSentPage - URL params:', { 
    ...
    const verify = async () => {
      try {
        ...
        const result = await verifyMagicLink(token, email, userType);
        ...
        if (result.success) {
          ...
          console.error('❌ Verification failed:', result.message);
          setStatus('error');
          setErrorMessage(result.message || 'Invalid or expired magic link');
        }
      } catch (error) {
      ...
      case 'success':
        return (
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Successfully verified!</h2>
            <p className="text-gray-600 mb-4">Welcome back, {userData?.email}!</p>
