...
// // Home.jsx (Updated with Background Image)
...
// import backgroundImage from '../assets/hero-background.jpg'; // Adjust path as needed
...
//         <div className="relative z-10 max-w-9xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 md:pt-32 md:pb-24">
//           <div className="text-center">
//             <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
//               Where <span className="text-blue-400">Expertise</span> Meets
...
//         {/* Stats Section - Moved outside hero to maintain visibility */}
//         <div className="relative z-10 bg-white/95 backdrop-blur-sm border-t border-b border-gray-200 py-8">
...
// Home.jsx (Updated with Background Image and Auth Redirect)
...
const Home = () => {
  const { user, loading, determineRedirectPath, profileCompletion } = useAuth();
  ...
  useEffect(() => {
    if (!loading && user) {
      const redirectPath = determineRedirectPath(user, profileCompletion);
      console.log('🔐 User is logged in, redirecting to:', redirectPath);
      navigate(redirectPath);
    }
  }, [user, loading, navigate, determineRedirectPath, profileCompletion]);
  ...
  // Don't render landing page if user is authenticated (redirect happens in useEffect)
  if (user) {
    return (
      <div className="min-h-screen flex justify-center items-center bg-gradient-to-b from-gray-50 to-white">
        <div className="text-center">
