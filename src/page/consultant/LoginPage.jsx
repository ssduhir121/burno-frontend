...
// // src/page/consultant/LoginPage.jsx
...
//     const result = await login(email, 'consultant');
...
//             <h1 className="text-2xl font-bold text-gray-900 mb-2">Welcome back, Consultant</h1>
...
//                     type="submit"
//                     disabled={isLoading}
//                     className="w-full bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 transition duration-300 font-medium flex items-center justify-center disabled:opacity-50"
//                   >
//                     {isLoading ? (
//                       <>
...
//                         className="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent"
//                         placeholder="••••••••"
//                       />
//                       <button
//                         type="button"
...
//                       </label>
//                     </div>
//                     <a href="/consultant/forgot-password" className="text-sm text-blue-600 hover:text-blue-500">
//                       Forgot password?
//                     </a>
//                   </div>
...
//               <Link to="/consultant/signup" className="text-blue-600 hover:text-blue-500 font-medium">
        ...
        <main className="flex-grow flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Click the link in the email to sign in securely to your consultant dashboard. The link will expire in 15 minutes.
            </p>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <p className="text-sm text-blue-800 flex items-start">
                ...
                <span>
                  ...
                  No password needed - it's more secure and you won't have to remember another password!
                </span>
              </p>
            </div>
