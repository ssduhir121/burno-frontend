...
//       // Use the new combined signup endpoint
...
//         if (data.error && data.error.includes('registered as a')) {
//           // Extract the role from error message
//           const roleMatch = data.error.match(/registered as a (\w+)/);
//           const registeredRole = roleMatch ? roleMatch[1] : 'different user type';
          
//           setErrors({ 
//             form: `This email is already registered as a ${registeredRole}. Please use the correct login page.` 
//           });
//         } else {
