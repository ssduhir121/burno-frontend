...
// import { useAuth } from '../../context/AuthContext'; // Make sure this imports updateProfileCompletion
// import {
//   User,
//   Mail,
//   Phone,
...
//   // Destructure updateProfileCompletion from useAuth
//   const { user, BACKEND_URL, updateProfileCompletion, profileCompletion } = useAuth();
...
//   useEffect(() => {
//     console.log('Current profile completion:', profileCompletion);
//   }, [profileCompletion]);
...
//     // Determine step from URL if available
...
//         const savedAvailability = localStorage.getItem('consultant_availability');
//         if (savedAvailability) {
//           try {
//             setFormData(prev => ({
//               ...prev,
//               availability_blocks: JSON.parse(savedAvailability)
//             }));
//           } catch (e) {
...
//       if (data.success) {
//         // Update profile completion for basic info
//         updateProfileCompletion('basic', true);
        
//         // Save to localStorage
//         localStorage.setItem('profile_setup_complete', 'basic');
        
//         setCurrentStep(2);
//         // Update URL
//         navigate('/consultant/profile-setup?step=availability', { replace: true });
//       } else {
...
//       localStorage.setItem('consultant_availability', JSON.stringify(formData.availability_blocks));
//       localStorage.setItem('profile_setup_complete', 'availability');
      
//       // IMPORTANT: Update profile completion for availability
      ...
      const response = await fetch(`${BACKEND_URL}/api/save-consultant-profile`, {
        ...
        body: JSON.stringify({
          ...
          formData: {
            full_name: formData.full_name,
            phone: formData.phone,
            dob: formData.dob, // Added DOB to the submission
            base_country: formData.base_country,
            base_city: formData.base_city,
            work_mode: formData.work_mode,
            travel_willingness: formData.travel_willingness,
                ...
                <div className="border-b border-gray-200 pb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-500">Your date of birth helps us verify your identity</p>
                    </div>
